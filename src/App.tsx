...
const Speakers = () => {
  const speakers = [
    ...
    { name: 'David Chernis', title: 'Director, Flexible Compute Platforms, CPower', linkedin: '' },
    { name: 'Nidhi Chadda', title: 'Founder & CEO, Enzo Advisors LLC', linkedin: '' },
    { name: 'Matthew Carmody', title: 'Sales Digital Infrastructure, Voltus', linkedin: '' },
  ...
  const days = [
    {
      ...
      sessions: [
        ...
        { time: '8:50–9:00 AM', title: 'Opening Remarks', speakers: ['Skidmore, Owings & Merrill'] },
        { time: '9:00–9:40 AM', title: 'Data Center Investing & Strategic Planning: From Permitting to Full Operations', speakers: ['Larry Skennion (Moderator), CEO, Green Panther Advisory', 'Kelly Bacon, Principal, AECOM', 'Bill Thomas, Chief Energy Officer, CleanArc Data Centers', 'Matt Short, Chief Commercial Officer, Paddle Energy'] },
        ...
        { time: '10:00–10:30 AM', title: 'Balancing Data Center Expansion: Addressing Equipment Reliability and Energy Efficiency', speakers: ['Scott Donachie (Moderator), CEO, Decarb Summits', 'Brian Weed, VP, Critical & Controlled Environment Services, GDI Integrated Facility Services'] },
        { time: '10:30–11:00 AM', title: 'Coffee & Networking', type: 'break' },
        { time: '11:00–11:30 AM', title: 'Building the Future: AI in Data Center Construction', speakers: ['Scott Donachie, CEO & Founder, Decarb Summits', 'Aundre Oldacre, Co-Founder & Managing Partner, AoRa Development', 'Kelsyn Rooks, Dir. of Strategic Accounts - AI Solutions, Cupix'] },
        { time: '11:30 AM–12:00 PM', title: 'Decarbonization Opportunities for Legacy Data Centers: Optimizing Existing Cooling Infrastructure', speakers: ['David Sattler, CEO, SCDesign'] },
        ...
        { time: '1:15–1:35 PM', title: 'Nuclear and Data Center Convergence: How Société Générale Sees Partnerships, Financing Structures, and Risk Mitigation Shaping Bankable, Large-Scale Deployments', speakers: ['Matt Kittell, Senior Financial Specialist, Société Générale'] },
        { time: '1:35–1:55 PM', title: 'Land, Leasing, and Real Estate Models', speakers: ['Jim Costello, Head of Real Estate Economics, Chief Economist, MSCI Real Assets'] },
        { time: '1:55–2:00 PM', title: 'Closing Remarks', type: 'closing' },
      ],
    },
    {
      label: 'Day 2',
