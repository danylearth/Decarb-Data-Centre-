...
const event: EventConfig = {
  slug: 'climate-week-kickoff',
  title: 'Climate Week Kickoff Summit',
  titleHtml: 'CLIMATE WEEK <br /> KICKOFF SUMMIT',
  ...
  whoShouldAttend: ['Investors', 'Asset Managers', 'Developers', 'Policymakers', 'Sustainability Leaders', 'Innovators'],
  partners: [],
  signupDescription: 'Sign up for updates on the Climate Week Kickoff Summit and future Decarb Summits events.',
  email: {
